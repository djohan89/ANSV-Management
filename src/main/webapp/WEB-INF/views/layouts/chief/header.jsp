					...
					<div class="dropdown-menu dropdown-menu-right notification">
						...
						<ul class="noti-body">
							...
							<li class="notification">
								<div class="media">
									<img class="img-radius" src="<c:url value='/assets/images/user/avatar-1.jpg' />" alt="Generic placeholder image">
							...
							<li class="notification">
								<div class="media">
									<img class="img-radius" src="<c:url value='/assets/images/user/avatar-2.jpg' />" alt="Generic placeholder image">
									<div class="media-body">
			...
			<li>
				<div class="dropdown drp-user">
					...
					<div class="dropdown-menu dropdown-menu-right profile-notification">
						<div class="pro-head">
							<img src="<c:url value='/assets/images/user/avatar-1.jpg' />" class="img-radius" alt="User-Profile-Image">
