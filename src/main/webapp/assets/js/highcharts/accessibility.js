...
(function (a) {
  ...
  t(a, "Accessibility/A11yI18n.js", [a["Core/FormatUtilities.js"], a["Core/Utilities.js"]], function (a, h) {
    ...
    (function (a) {
      ...
      function v(a, c, e) {
        ...
        do {
          var u = d(a, f);
          var y = a.substring(f, u && u.begin - 1);
          y.length && b.push({
            value: y,
            type: "constant"
          });
        ...
        b.forEach(function (b) {
          "statement" === b.type && (b.value = m(b.value, c))
        });
        return k(b.reduce(function (b, d) {
          return b + d.value
        }, ""), c, e)
      }
      ...
      function g(a, c) {
        a = a.split(".");
        for (var e = this.options.lang, d = 0; d < a.length; ++d) e =
          e && e[a[d]];
        return "string" === typeof e ? v(e, c, this) : ""
      }
      var n = [];
      a.compose = function (a) {
        -1 === n.indexOf(a) && (n.push(a), a.prototype.langFormat = g);
        return a
      };
      a.i18nFormat = v
    })(m || (m = {}));
  ...
  t(a, "Accessibility/Utils/HTMLUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, h) {
    function k(a) {
      ...
      if (m.createEvent) {
        var v = m.createEvent("MouseEvent");
        if (v.initMouseEvent) return v.initMouseEvent(a.type, a.bubbles, a.cancelable,
    ...
    function q(a, g) {
      ...
      if ("function" === typeof w.MouseEvent) return new w.MouseEvent(a, {
        bubbles: !0,
        cancelable: !0,
        composed: !0,
        view: w,
      ...
      if (m.createEvent) {
        var v = m.createEvent("MouseEvent");
        if (v.initMouseEvent) return v.initMouseEvent(a, !0, !0, w, "click" === a ? 1 : 0, g.x, g.y, g.x, g.y, !1, !1, !1,
          !1, 0, null), v
      }
      return {
        type: a
    ...
    return {
      ...
      cloneTouchEvent: function (a) {
        ...
        if ("function" === typeof w.TouchEvent) return g = new w.TouchEvent(a.type, {
          touches: g(a.touches),
  ...
  t(a, "Accessibility/Utils/ChartUtilities.js", [a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, r) {
    function k(b, f) {
      var a = f.type,
        c = b.hcEvents;
      n.createEvent && (b.dispatchEvent || b.fireEvent) ? b.dispatchEvent ? b.dispatchEvent(f) : b.fireEvent(a, f) : c && c[a] ? d(b, a, f) : b.element && k(b.element, f)
    }
    ...
    function m(b) {
      ...
      return d.langFormat("accessibility.axis.timeRange" + c, {
        chart: d,
        axis: b,
        range: e.replace(".0", "")
      })
    ...
    return {
      ...
      getChartTitle: function (b) {
        return x(b.options.title.text || b.langFormat("accessibility.defaultChartTitle", {
          chart: b
        }))
      },
      ...
      getAxisRangeDescription: function (b) {
        ...
        }) : "", b) : !b.dateTime || 0 !== b.min && 0 !== b.dataMin ? w(b) : m(b)
      },
      getPointFromXY: function (b, d, a) {
        for (var f = b.length, c; f--;)
          if (c = e(b[f].points || [], function (b) {
              return b.x === d && b.y === a
            })) return c
      },
      getSeriesFirstPointElement: C,
      ...
      scrollToPoint: function (b) {
        var a = b.series.xAxis,
          e = b.series.yAxis,
          y = a && a.scrollbar ? a : e;
        if ((a = y && y.scrollbar) && c(a.to) && c(a.from)) {
          e = a.to - a.from;
          if (c(y.dataMin) && c(y.dataMax)) {
            var g = y.toPixels(y.dataMin),
              x = y.toPixels(y.dataMax);
            b = (y.toPixels(b["xAxis" === y.coll ? "x" : "y"] || 0) - g) / (x - g)
          } else b = 0;
          a.updatePosition(b -
            e / 2, b + e / 2);
          d(a, "changed", {
  ...
  t(a, "Accessibility/Utils/EventProvider.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, h) {
    var k = h.addEvent;
    return function () {
      function h() {
        this.eventRemovers = []
  ...
  t(a, "Accessibility/AccessibilityComponent.js", [a["Accessibility/Utils/ChartUtilities.js"],
    ...
    q = function () {
      ...
      a.prototype.addEvent = function (a, n, x, c) {
        return this.eventProvider.addEvent(a, n, x, c)
      };
    ...
    a = function () {
      ...
      a.prototype.run = function (a) {
        var k = a.which || a.keyCode,
          ...
          r = h(this.keyCodeMap, function (a) {
            return -1 < a[0].indexOf(k)
          });
        r ? w = r[1].call(this, k, a) : 9 === k && (w = this.response[a.shiftKey ? "prev" : "next"]);
        return w
      };
      return a
    }();
  ...
  t(a, "Accessibility/Components/ContainerComponent.js", [a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, r, q, m) {
    var k = this && this.__extends || function () {
      ...
      C = r.unhideChartElementFromAT,
      v = r.getChartTitle,
      g = q.doc,
      n = m.stripHTMLTagsFromString;
    return function (a) {
      function c() {
      ...
      c.prototype.handleSVGTitleElement = function () {
        var a = this.chart,
          ...
          b = n(a.langFormat("accessibility.svgContainerTitle", {
            chartTitle: v(a)
          }));
        if (b.length) {
      ...
      c.prototype.setRenderToAttrs = function () {
        var a = this.chart;
        "disabled" !== a.options.accessibility.landmarkVerbosity ? a.renderTo.setAttribute("role", "region") :
    ...
    (function (h) {
      ...
      function n(b, d) {
        ...
        var e = c.x - f,
          ...
          h = c.height + 2 * f,
          z = this instanceof a;
        if ("text" === this.element.nodeName || z) {
          var E = !!this.rotation;
          if (z) var D = {
            x: E ? 1 : 0,
            y: 0
            ...
            var F = D = 0;
            "middle" === this.attr("text-anchor") ? D = F = .5 : this.rotation ? D = .25 : F = .75;
            D = {
              x: D,
              y: F
            }
          ...
          F = +this.attr("x");
          var p = +this.attr("y");
          isNaN(F) || (e = F - c.width * D.x - f);
          isNaN(p) || (u = p - c.height * D.y - f);
          z && E && (z = n, n = h, h = z, isNaN(F) || (e = F - c.height * D.x - f), isNaN(p) || (u = p - c.width * D.y - f))
        }
        this.focusBorder = this.renderer.rect(e, u, n, h, parseInt((d && d.r || 0).toString(), 10)).addClass("highcharts-focus-border").attr({
          zIndex: 99
      ...
      function x(a) {
        ...
        a.focusBorderUpdateHooks ||
          (a.focusBorderUpdateHooks = {}, b.forEach(function (b) {
            b += "Setter";
      ...
      h.compose = function (a, b) {
        -1 === d.indexOf(a) && (d.push(a), a = a.prototype, a.renderFocusBorder = m, a.setFocusToElement = v); - 1 === d.indexOf(b) && (d.push(b), b = b.prototype, b.addFocusBorder = n, b.removeFocusBorder = c)
      }
    })(m || (m = {}));
    return m
  });
  t(a, "Accessibility/Utils/Announcer.js", [a["Core/Renderer/HTML/AST.js"], a["Accessibility/Utils/DOMElementProvider.js"],
    a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]
  ], function (a, h, r, q, m) {
    var k = r.doc,
      C = q.addClass,
      v = q.visuallyHideElement,
      g = m.attr;
    return function () {
      function n(a, c) {
        this.chart = a;
      ...
      n.prototype.announce = function (g) {
        var c = this;
      ...
      n.prototype.addAnnounceRegion = function (a) {
        ...
        this.chart.styledMode ? C(e, "highcharts-visually-hidden") : v(e);
        c.appendChild(e);
        return e
      };
  ...
  t(a, "Accessibility/Components/AnnotationsA11y.js", [a["Accessibility/Utils/HTMLUtilities.js"]], function (a) {
    ...
    function q(a) {
      ...
      var n = k(a),
        ...
        c = h.length,
        e = "accessibility.screenReaderSection.annotations.description" +
    ...
    function m(a) {
      return h(a).map(function (a) {
        return (a = w(C(q(a)))) ? "<li>" + a + "</li>" : ""
      })
    }
    var w = a.escapeStringForHTML,
      C = a.stripHTMLTagsFromString;
    return {
      getAnnotationsInfoHTML: function (a) {
        var g = a.annotations;
        return g && g.length ? '<ul style="list-style-type: none">' + m(a).join(" ") + "</ul>" : ""
      },
  ...
  t(a, "Accessibility/Components/InfoRegionsComponent.js", [a["Accessibility/A11yI18n.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/Components/AnnotationsA11y.js"], a["Core/Renderer/HTML/AST.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"],
  ...
  ], function (a, h, r, q, m, w, C, v, g, n) {
    function x(a, b) {
      var d = b[0],
        l = a.series && a.series[0] || {};
      l = {
        numSeries: a.series.length,
        numPoints: l.points && l.points.length,
        chart: a,
        mapTitle: l.mapTitle
      };
      if (!d) return a.langFormat("accessibility.chartTypes.emptyChart", l);
      if ("map" === d) return l.mapTitle ? a.langFormat("accessibility.chartTypes.mapTypeDescription", l) : a.langFormat("accessibility.chartTypes.unknownMap", l);
      if (1 < a.types.length) return a.langFormat("accessibility.chartTypes.combinationChart",
        l);
      b = b[0];
      d = a.langFormat("accessibility.seriesTypeDescriptions." + b, l);
      var c = a.series && 2 > a.series.length ? "Single" : "Multiple";
      return (a.langFormat("accessibility.chartTypes." + b + c, l) || a.langFormat("accessibility.chartTypes.default" + c, l)) + (d ? " " + d : "")
    }
    var c = this && this.__extends || function () {
      ...
      I = g.stripHTMLTagsFromString,
      z = g.visuallyHideElement,
      E = n.attr,
      D = n.pick;
    return function (g) {
      function p() {
      ...
      p.prototype.setLinkedDescriptionAttrs = function () {
        ...
        a && (a.setAttribute("aria-hidden", "true"), G(a, "highcharts-linked-description"))
      };
      p.prototype.updateScreenReaderSection = function (a) {
        var b = this.chart,
          d = this.screenReaderSections[a],
          c = d.buildContent(b),
          A = d.element = d.element || this.createElement("div"),
          e = A.firstChild || this.createElement("div");
        c ? (this.setScreenReaderSectionAttribs(A, a), m.setElementHTML(e,
      ...
      p.prototype.setScreenReaderSectionAttribs = function (a, b) {
        var d = this.chart,
          c = d.langFormat("accessibility.screenReaderSection." + b + "RegionLabel", {
            chart: d,
            chartTitle: f(d)
          });
        E(a, {
      ...
      p.prototype.defaultBeforeChartFormatter = function () {
        ...
        var c = this.getAxesDescription(),
          L = b.sonify && b.options.sonification && b.options.sonification.enabled,
          J = "highcharts-a11y-sonify-data-btn-" + b.index,
          u = "hc-linkto-highcharts-data-table-" + b.index,
          p = e(b),
          y = b.langFormat("accessibility.screenReaderSection.annotations.heading", {
            chart: b
          });
        c = {
      ...
      p.prototype.getTypeDescriptionText =
        function () {
          var a = this.chart;
          return a.types ? a.options.accessibility.typeDescription || x(a, a.types) : ""
        };
      p.prototype.getDataTableButtonText = function (a) {
        var b = this.chart;
      ...
      p.prototype.getSonifyButtonText = function (a) {
        var b = this.chart;
      ...
      p.prototype.onDataTableCreated = function (a) {
        var b = this.chart;
      ...
      p.prototype.initSonifyButton = function (a) {
        var b = this,
          d = this.sonifyButton = t(a),
          c = this.chart,
          e = function (a) {
      ...
      p.prototype.initDataTableButton = function (a) {
        var b = this.viewDataTableButton = t(a),
          d = this.chart;
        ...
        b && (E(b, {
          ...
          d.options.accessibility.screenReaderSection.onViewDataTableClick || function () {
            d.viewData()
          })
      };
      ...
      p.prototype.getAxisDescriptionText =
        function (a) {
          var c = this.chart,
            e = c[a];
          return c.langFormat("accessibility.axis." + a + "Description" + (1 < e.length ? "Plural" : "Singular"), {
            chart: c,
            names: e.map(function (a) {
              return d(a)
            }),
            ranges: e.map(function (a) {
              return b(a)
            }),
            numAxes: e.length
          })
  ...
  t(a, "Accessibility/Components/MenuComponent.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"],
    ...
    h = function (a) {
      ...
      c.prototype.onChartRender = function () {
        ...
        this.exportButtonProxy && b && b === a.exportingGroup && (b.focusBorder ? a.setFocusToElement(b,
      ...
      c.prototype.proxyMenuButton = function () {
        var a = this.chart,
          ...
          y = a.exportSVGElements && a.exportSVGElements[0];
        e && !1 !== e.enabled && e.accessibility && e.accessibility.enabled && y && y.element && c && (this.exportButtonProxy = b.addProxyElement("chartMenu", {
          click: c
        }, {
    ...
    (function (c) {
      function e() {
        ...
        if (a && (a = a.element, a.onclick)) a.onclick(x("click"))
      }

      function d() {
        var a = this.exportDivElements;
        a && this.exportContextMenu && this.openMenu && (a.forEach(function (a) {
          if (a && "highcharts-menu-item" === a.className && a.onmouseout) a.onmouseout(x("mouseout"))
      ...
      function b(a) {
        ...
        if (b && "LI" === b.tagName && (!b.children || !b.children.length)) {
          ...
          b.focus && c && b.focus();
          if (d && d.onmouseout) d.onmouseout(x("mouseout"));
          if (b.onmouseover) b.onmouseover(x("mouseover"));
  ...
  t(a, "Accessibility/KeyboardNavigation.js", [a["Core/Globals.js"], a["Accessibility/Components/MenuComponent.js"], a["Core/Utilities.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, r, q, m) {
    ...
    r = function () {
      ...
      a.prototype.updateExitAnchor = function () {
        var a = n("highcharts-end-of-chart-marker-" + this.chart.index);
      ...
      a.prototype.addExitAnchorEventsToEl = function (a) {
        ...
        this.eventProvider.addEvent(a, "focus", function (a) {
          ...
          b ? (d.tabbingInBackwards = !0, d.tabindexContainer.focus(), delete d.tabbingInBackwards, a.preventDefault(), d.modules && d.modules.length && (d.currentModuleIx =
    ...
    (function (n) {
      ...
      n.compose = function (a) {
        h.compose(a); - 1 === d.indexOf(a) && (d.push(a), a.prototype.dismissPopupContent = c); - 1 === d.indexOf(k) && (d.push(k), v(k, "keydown", e));
        return a
      }
    })(r || (r = {}));
    return r
  ...
  t(a, "Accessibility/Components/LegendComponent.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Globals.js"],
    a["Core/Legend/Legend.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]
  ], function (a, h, r, q, m, w, C, v) {
    function g(a) {
    ...
    a = function (a) {
      ...
      b.prototype.init = function () {
        ...
        this.addEvent(r, "afterPositionItem", function (b) {
          this.chart === a.chart && this.chart.renderer && a.updateProxyPositionForItem(b.item)
        });
        this.addEvent(r, "afterRender", function () {
          this.chart === a.chart && this.chart.renderer && a.recreateProxies() && y(function () {
            return a.proxyProvider.updateGroupProxyElementPositions("legend")
          }, c(u(this.chart.renderer.globalAnimation, !0)).duration)
        })
      };
      b.prototype.updateLegendItemProxyVisibility = function () {
        ...
        (b.allItems || []).forEach(function (e) {
          if (e.a11yProxyElement) {
            var l = e.a11yProxyElement.element,
              f = !1;
            if (b.pages && b.pages.length) {
              ...
              f = A + e - b.pages[f] > c || f !== d - 1
            }
            f ? a.styledMode ? H(l, "highcharts-a11y-invisible") : l.style.visibility = "hidden" : (B(l, "highcharts-a11y-invisible"), l.style.visibility = "")
          }
        })
      };
      ...
      b.prototype.highlightAdjacentLegendPage =
        function (a) {
          var b = this.chart,
            d = b.legend;
          a = (d.currentPage || 1) + a;
          ...
          if (0 < a && a <= c.length) {
            c = d.allItems.length;
            for (var e = 0; e < c; ++e)
              if (d.allItems[e].pageIx + 1 === a) {
                b.highlightLegendItem(e) && (this.highlightedLegendItemIx = e);
                break
              }
          }
        };
      ...
      b.prototype.recreateProxies = function () {
        ...
        a = a && b && b.contains(a);
        this.removeProxies();
        return g(this.chart) ? (this.addLegendProxyGroup(),
      ...
      b.prototype.updateLegendTitle = function () {
        var a = this.chart,
          b = t((a.legend && a.legend.options.title && a.legend.options.title.text || "").replace(/<br ?\/?>/g, " "));
      ...
      b.prototype.onKbdArrowKey = function (a,
        ...
        var d = this.keyCodes,
          c = a.response,
          e = this.chart,
          l = e.options.accessibility,
          f = e.legend.allItems.length;
        b = b === d.left || b === d.up ? -1 : 1;
        if (e.highlightLegendItem(this.highlightedLegendItemIx + b)) return this.highlightedLegendItemIx += b, c.success;
        1 < f && l.keyboardNavigation.wrapAround && a.init(b);
        return c.success
      };
      ...
      b.prototype.shouldHaveLegendNavigation =
        function () {
          var a = this.chart,
    ...
    (function (a) {
      function b(a) {
        var b = this.legend.allItems,
          ...
          c = b[a];
        return c ? (f(d) && b[d] && n(!1, b[d]), b = this.legend, a = b.allItems[a].pageIx, d = b.currentPage, "undefined" !== typeof a && a + 1 !==
  ...
  t(a, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [a["Accessibility/Components/AnnotationsA11y.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, r, q, m) {
    function k(a) {
      var b = a.index;
      return a.series && a.series.data && A(b) ? D(a.series.data, function (a) {
    ...
    function v(a) {
      ...
      return !C(a) && !b.exposeAsGroupOnly
    }
    ...
    function d(a) {
      var b = a.series,
        ...
        c = a.series;
      var f = c.chart;
      var l = c.options.accessibility;
      l = l && l.point && l.point.valueDescriptionFormat || f.options.accessibility.point.valueDescriptionFormat;
      c = p(c.xAxis && c.xAxis.options.accessibility && c.xAxis.options.accessibility.enabled, !f.angular);
      if (c) {
        var g = a.series;
        var y = g.chart;
        var h = g.options.accessibility && g.options.accessibility.point || {},
          k = y.options.accessibility.point || {};
        (g = g.xAxis && g.xAxis.dateTime) ? (g = g.getXDateFormat(a.x || 0, y.options.tooltip.dateTimeLabelFormats), h = h.dateFormatter && h.dateFormatter(a) || k.dateFormatter && k.dateFormatter(a) || h.dateFormat || k.dateFormat || g, y = y.time.dateFormat(h, a.x || 0, void 0)) : y = void 0;
        h = (a.series.xAxis || {}).categories && A(a.category) && ("" + a.category).replace("<br/>", " ");
        k = a.id && 0 > a.id.indexOf("highcharts-");
        g = "x, " + a.x;
        y = a.name || y || h || (k ? a.id : g)
      } else y = "";
      h = A(a.index) ? a.index + 1 : "";
      k = a.series;
      var x = k.chart.options.accessibility.point || {},
        z = k.chart.options.accessibility && k.chart.options.accessibility.point || {},
        m = k.tooltipOptions || {};
      g = z.valuePrefix || x.valuePrefix || m.valuePrefix || "";
      x = z.valueSuffix || x.valueSuffix || m.valueSuffix || "";
      z = n(a, a["undefined" !== typeof a.value ? "value" : "y"]);
      k = a.isNull ? k.chart.langFormat("accessibility.series.nullPointValue", {
        point: a
      }) : k.pointArrayMap ? e(a, g, x) : g + z + x;
      f = B(l, {
        point: a,
        index: h,
        xDescription: y,
      ...
      l = (l = a.options && a.options.accessibility && a.options.accessibility.description) ?
        " " + l : "";
      b = d ? " " + b.name + "." : "";
      d = a.series.chart;
      c = u(a);
      ...
      d = c.length ? d.langFormat("accessibility.series.pointAnnotationsDescription", y) : "";
    ...
    function b(a) {
      ...
      (b || c) && a.points.forEach(function (c) {
        ...
        if (!(e = c.graphic && c.graphic.element) && (e = c.series && c.series.is("sunburst"), e = c.isNull && !e)) {
          var f = c.series,
            l = k(c);
          f = (e = l && l.graphic) ? e.parentGroup : f.graph || f.group;
          l = l ? {
            x: p(c.plotX, l.plotX, 0),
            y: p(c.plotY, l.plotY, 0)
          } : {
            x: p(c.plotX, 0),
            y: p(c.plotY, 0)
          };
          l = c.series.chart.renderer.rect(l.x, l.y, 1, 1);
          l.attr({
          ...
          f && f.element ? (c.graphic = l, c.hasDummyGraphic = !0, l.add(f), f.element.insertBefore(l.element, e ? e.element : null), e = l.element) : e = void 0
        }
        f = c.options && c.options.accessibility && !1 === c.options.accessibility.enabled;
        e && (e.setAttribute("tabindex", "-1"), a.chart.styledMode || (e.style.outline =
    ...
    function f(a) {
      ...
      return (b.langFormat("accessibility.series.summary." + a.type + d, u) || b.langFormat("accessibility.series.summary.default" + d, u)) + (e ? " " + e : "") + (f("yAxis") ? " " + A : "") + (f("xAxis") ? " " + l : "")
    }
    var u = a.getPointAnnotationTexts,
      y = h.getAxisDescription,
      M = h.getSeriesFirstPointElement,
      t = h.getSeriesA11yElement,
      H = h.unhideChartElementFromAT,
      B = r.format,
      I = r.numberFormat,
      z = q.reverseChildNodes,
      E = q.stripHTMLTagsFromString,
      D = m.find,
      F =
      m.isNumber,
      p = m.pick,
    ...
    return {
      ...
      describeSeries: function (a) {
        ...
        if (e) {
          ...
          var A = (a.options.accessibility || {}).exposeAsGroupOnly;
          d.options3d && d.options3d.enabled && c || !(c || l || A || C(a)) ? e.setAttribute("aria-label", "") : (d = a.chart.options.accessibility,
  ...
  t(a, "Accessibility/ProxyElement.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/EventProvider.js"],
    ...
    var k = a.doc,
      ...
      v = h.css,
      g = h.merge,
      n = q.fireEventOnWrappedOrUnwrappedElement,
      x = m.cloneMouseEvent,
      c = m.cloneTouchEvent,
  ...
  t(a, "Accessibility/ProxyProvider.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/DOMElementProvider.js"],
    a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/ProxyElement.js"]
  ], function (a, h, r, q, m, w) {
    var k = a.doc,
      v = h.attr,
      g = h.css,
      n = r.unhideChartElementFromAT,
      x = m.removeElement,
    ...
    return function () {
      ...
      a.prototype.addProxyElement = function (a,
        b, c) {
        var d = this.groups[a];
      ...
      a.prototype.addGroup = function (a, b, c) {
        ...
        e.className = "highcharts-a11y-proxy-group highcharts-a11y-proxy-group-" +
          a.replace(/\W/g, "-");
        this.groups[a] = {
      ...
      a.prototype.clearGroup = function (a) {
        var b = this.groups[a];
        if (!b) throw Error("ProxyProvider.clearGroup: Invalid group key " +
          a);
        c(b.proxyContainerElement)
      };
      a.prototype.removeGroup = function (a) {
        var b = this.groups[a];
        b && (x(b.groupElement), delete this.groups[a])
      };
  ...
  t(a, "Extensions/RangeSelector.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"],
    ...
    var E = function () {
      ...
      f.prototype.clickButton = function (b, d) {
        var e = this.chart,
          ...
          f = e.xAxis[0],
          A = e.scroller && e.scroller.getUnionExtremes() ||
          f || {},
          h = A.dataMin,
          n = A.dataMax,
          p = f && Math.round(Math.min(f.max, B(n, f.max))),
          k = l.type;
        A = l._range;
        var x, m = l.dataGrouping;
        if (null !== h && null !== n) {
          e.fixedRange = A;
          this.setSelected(b);
          m && (this.forcedDataGrouping = !0, a.prototype.setDataGrouping.call(f || {
            chart: this.chart
          }, m, !1), this.frozenStates = l.preserveDataGrouping);
          if ("month" === k || "year" === k)
            if (f) {
              k = {
                range: l,
              ...
              var q = f.minFromRange.call(k);
              y(k.newMax) && (p = k.newMax)
            } else A = l;
          else if (A) q = Math.max(p - A, h), p = Math.min(q + A, n);
          else if ("ytd" ===
            k)
            if (f) "undefined" === typeof n && (h = Number.MAX_VALUE, n = Number.MIN_VALUE, e.series.forEach(function (a) {
              a = a.xData;
              h = Math.min(a[0], h);
              n = Math.max(a[a.length - 1], n)
            }), d = !1), p = this.getYTDExtremes(n, h, e.time.useUTC), q = x = p.min, p = p.max;
            else {
              this.deferredYTDClick = b;
              return
            }
          else "all" === k && f && (e.navigator && e.navigator.baseSeries[0] && (e.navigator.baseSeries[0].xAxis.options.range = void 0), q = h, p = n);
          c(q) && (q += l._offsetMin);
          c(p) && (p += l._offsetMax);
          this.dropdown && (this.dropdown.selectedIndex = b + 1);
          if (f) f.setExtremes(q, p,
            B(d, !0), void 0, {
              trigger: "rangeSelectorButton",
              rangeSelectorButton: l
            });
          else {
            var r = z(e.options.xAxis)[0];
            var v = r.range;
            r.range = A;
            var w = r.min;
            r.min = x;
      ...
      f.prototype.updateButtonStates = function () {
        var a = this,
          ...
          h = g.dataMin,
          p = g.dataMax;
        b = a.getYTDExtremes(p, h, b.time.useUTC);
        var n = b.min,
          k = b.max,
          u = a.selected,
          x = y(u),
          ...
          z = a.buttons;
        a.buttonOptions.forEach(function (b, l) {
          var A = b._range,
            g = b.type,
            J = b.count || 1,
            L = z[l],
          ...
          ("month" === g || "year" === g) && e + 36E5 >= 864E5 * {
            ...
            month: 31,
            year: 366
          } [g] * J + N ? A = !0 : "ytd" === g ? (A = k - n + N === e, r = !b) : "all" === g && (A = c.max - c.min >= p - h, B = !b && x && A);
          g = !m && (y || q || B || f);
          J = b && A || A && !x && !r || b && a.frozenStates;
          g ? K = 3 : J && (x = !0, K = 2);
          L.state !== K && (L.setState(K), d && (d.options[l + 1].disabled = g, 2 === K && (d.selectedIndex = l + 1)), 0 === K && u === l && a.setSelected())
        })
      };
      ...
      f.prototype.setInputValue = function (a, b) {
        ...
        if (f) {
          ...
          l = c(l) ? Number(l) : void 0;
          c(b) && (c(l) && f.setAttribute("data-hc-time-previous", l), f.setAttribute("data-hc-time", b), l = b);
          f.value = e.dateFormat(this.inputTypeFormats[f.type] || d.inputEditDateFormat, l);
          a && a.attr({
            text: e.dateFormat(d.inputDateFormat, l)
          })
        }
      };
      ...
      f.prototype.hideInput = function (a) {
        (a = "min" === a ? this.minInput : this.maxInput) && x(a, {
          top: "-9999em",
          border: 0,
          width: "1px",
          height: "1px"
      ...
      f.prototype.defaultInputDateParser = function (a, b, d) {
        ...
        if (b) c += "Z";
          ...
          var e;
          if (e = r.isSafari) e = c, e = !(6 < e.length && (e.lastIndexOf("-") ===
            e.length - 6 || e.lastIndexOf("+") === e.length - 6));
          e && (e = (new Date(c)).getTimezoneOffset() / 60, c += 0 >= e ? "+" + H(-e) + ":00" : "-" + H(e) + ":00")
        }
        c = Date.parse(c);
        y(c) || (a = a.split("-"), c = Date.UTC(I(a[0]), I(a[1]) - 1, I(a[2])));
        d && b && y(c) && (c += d.getTimezoneOffset(c));
        return c
      };
      f.prototype.drawInput = function (a) {
        function d() {
          ...
          var l = g.maxInput,
            A = g.minInput;
          b !== Number(z.getAttribute("data-hc-time-previous")) && y(b) &&
            (z.setAttribute("data-hc-time-previous", b), u && l && y(f) ? b > Number(l.getAttribute("data-hc-time")) ? b = void 0 : b < f && (b = f) : A && y(e) && (b < Number(A.getAttribute("data-hc-time")) ? b = void 0 : b > e && (b = e)), "undefined" !== typeof b && d.setExtremes(u ? b : d.min, u ? d.max : b, void 0, void 0, {
        ...
        var c = this.chart,
          ...
          u = "min" === a,
          m = v.lang[u ? "rangeSelectorFrom" : "rangeSelectorTo"] || "";
        m = h.label(m, 0).addClass("highcharts-range-label").attr({
          padding: m ?
            2 : 0,
          height: m ? p.inputBoxHeight : 0
        }).add(f);
        ...
        z.setAttribute("type", k(p.inputDateFormat || "%b %e, %Y"));
        c.styledMode || (m.css(t(A, p.labelStyle)), h.css(t({
            color: "#333333"
          },
          A, p.inputStyle)), x(z, b({
          position: "absolute",
          border: 0,
      ...
      f.prototype.render =
        function (a, b) {
          var d = this.chart,
            ...
            l = d.options,
            g = l.rangeSelector,
            h = B(l.chart.style && l.chart.style.zIndex, 0) + 1;
          l = g.inputEnabled;
          if (!1 !== g.enabled) {
            this.rendered || (this.group = e.g("range-selector-group").attr({
              zIndex: 7
            }).add(), this.div = n("div", void 0, {
              position: "relative",
              height: 0,
              zIndex: h
            }), this.buttonOptions.length && this.renderButtons(), f.parentNode && f.parentNode.insertBefore(this.div, f), l && (this.inputGroup = e.g("input-group").add(this.group), e = this.drawInput("min"), this.minDateBox =
              e.dateBox, this.minLabel = e.label, this.minInput = e.input, e = this.drawInput("max"), this.maxDateBox = e.dateBox, this.maxLabel = e.label, this.maxInput = e.input));
            if (l && (this.setInputValue("min", a), this.setInputValue("max", b), a = d.scroller && d.scroller.getUnionExtremes() || d.xAxis[0] || {}, c(a.dataMin) && c(a.dataMax) && (d = d.xAxis[0].minRange || 0, this.setInputExtremes("min", a.dataMin, Math.min(a.dataMax, this.getInputValue("max")) - d), this.setInputExtremes("max", Math.max(a.dataMin, this.getInputValue("min")) + d, a.dataMax)),
                this.inputGroup)) {
              var A = 0;
      ...
      f.prototype.alignElements = function () {
        var a = this,
          ...
          h = this.zoomText,
          p = c.options,
          n = p.exporting && !1 !== p.exporting.enabled && p.navigation && p.navigation.buttonOptions;
        p = g.buttonPosition;
        var k = g.inputPosition,
          u = g.verticalAlign,
          z = function (b, d) {
            return n && a.titleCollision(c) && "top" === u && "right" === d.align && d.y - b.getBBox().height - 12 < (n.y || 0) + (n.height || 0) + c.spacing[0] ? -40 : 0
          },
          x = c.plotLeft;
        if (e && p && k) {
          var m = p.x - c.spacing[3];
          if (b) {
            this.positionButtons();
            if (!this.initialButtonGroupWidth) {
              var y = 0;
              h && (y += h.getBBox().width + 5);
          ...
          b = 0;
          f && (b = z(f, k), "left" === k.align ? m = x : "right" === k.align && (m = -Math.max(c.axisOffset[1], -b)), f.align({
              y: k.y,
              width: f.getBBox().width,
              align: k.align,
              x: k.x + m - 2
            }, !0,
            c.spacingBox), f.placed = c.hasLoaded);
          ...
          z = 0;
          "bottom" === u && (z = (z = c.legend && c.legend.options) && "bottom" === z.verticalAlign && z.enabled && !z.floating ? c.legend.legendHeight + B(z.margin, 10) : 0, b = b + z - 20, z = f - b - (g.floating ? 0 : g.y) - (c.titleOffset ? c.titleOffset[2] : 0) - 10);
          if ("top" === u) g.floating && (z = 0), c.titleOffset && c.titleOffset[0] && (z = c.titleOffset[0]), z += c.margin[0] - c.spacing[0] || 0;
          else if ("middle" ===
            u)
            if (k.y === p.y) z = f;
            else if (k.y || p.y) z = 0 > k.y || 0 > p.y ? z - Math.min(k.y, p.y) : f - b;
          e.translate(g.x, g.y + Math.floor(z));
          p = this.minInput;
          k = this.maxInput;
          f = this.dropdown;
          g.inputEnabled && p && k && (p.style.marginTop = e.translateY + "px", k.style.marginTop = e.translateY + "px");
      ...
      f.prototype.alignButtonGroup = function (a, b) {
        var d = this.chart,
          ...
          g = e.x - d.spacing[3];
        "right" === e.align ? g += a - f : "center" === e.align && (g -= f /
          2);
        c && c.align({
          y: e.y,
      ...
      f.prototype.positionButtons = function () {
        ...
        c && "hidden" !== c.visibility && (c[e]({
          x: B(g + f.x, g)
        }), h += f.x + c.getBBox().width + 5);
        this.buttonOptions.forEach(function (b, c) {
          if ("hidden" !== a[c].visibility) a[c][e]({
            x: h
          }), h += a[c].width + d.buttonSpacing;
          else a[c][e]({
            x: g
          })
        })
      };
      f.prototype.handleCollision =
        function (a) {
          var b = this,
            d = this.chart,
            c = this.buttonGroup,
          ...
          var k = function (b) {
              if (e && c) {
                var d = e.alignAttr.translateX + e.alignOptions.x - a + e.getBBox().x + 2,
                  ...
                  l = c.alignAttr.translateX + c.getBBox().x;
                return l + b > d && d + f > l && g.y < p.y + e.getBBox().height
              }
              return !1
            },
            n = function () {
          ...
          e && c ? p.align === g.align || k(this.initialButtonGroupWidth + 20) ? "responsive" === h ? (this.collapseButtons(a), k(f()) && n()) : n() : "responsive" === h && this.expandButtons() : c && "responsive" === h && (this.initialButtonGroupWidth > d.plotWidth ? this.collapseButtons(a) : this.expandButtons())
        };
      f.prototype.collapseButtons = function (a) {
        var b = this.buttons,
          ...
          f = this.options,
          g = this.zoomText,
          h = c.userOptions.rangeSelector && c.userOptions.rangeSelector.buttonTheme || {},
          p = function (a) {
            return {
              text: a ? a + " \u25be" : "\u25be",
              width: "auto",
              paddingLeft: B(f.buttonTheme.paddingLeft, h.padding, 8),
              paddingRight: B(f.buttonTheme.paddingRight, h.padding, 8)
            }
          };
        g && g.hide();
        var k = !1;
        d.forEach(function (a, d) {
          d = b[d];
          2 !== d.state ? d.hide() : (d.show(), d.attr(p(a.text)), k = !0)
        });
        k || (e && (e.selectedIndex = 0), b[0].show(), b[0].attr(p(this.zoomText &&
          this.zoomText.textStr)));
      ...
      f.prototype.expandButtons = function () {
        ...
        b.forEach(function (b, c) {
          ...
          c.attr({
            ...
            paddingRight: B(d.buttonTheme.paddingRight,
              "unset")
          });
    ...
    a.prototype.minFromRange = function () {
      ...
      if (y(a)) {
        var f = d - a;
        var g = a
      } else f = d + e(d, -a.count), this.chart && (this.chart.fixedRange = d - f);
    ...
    if (!r.RangeSelector) {
      ...
      g(h, "beforeRender", function () {
        ...
        b && (y(b.deferredYTDClick) && (b.clickButton(b.deferredYTDClick), delete b.deferredYTDClick), a.forEach(function (a) {
          a.updateNames();
          a.setScale()
      ...
      g(h, "update", function (a) {
        ...
        b &&
          b.enabled && !c(a) && this.options.rangeSelector && (this.options.rangeSelector.enabled = !0, this.rangeSelector = a = new E(this));
  ...
  t(a, "Accessibility/Components/RangeSelectorComponent.js",
    [a["Extensions/RangeSelector.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Core/Utilities.js"]],
    function (a, h, r, q, m, w) {
      var k = this && this.__extends || function () {
          var a = function (c, d) {
            a = Object.setPrototypeOf || {
        ...
        v = r.unhideChartElementFromAT,
        g = r.getAxisRangeDescription,
        n = w.addEvent,
        x = w.attr;
      h = function (a) {
        function c() {
        ...
        c.prototype.onChartUpdate = function () {
          var a = this.chart,
            b = this,
            c = a.rangeSelector;
          c && (this.updateSelectorVisibility(), this.setDropdownAttrs(), c.buttons && c.buttons.length &&
        ...
        c.prototype.onButtonNavKbdArrowKey =
          function (a, b) {
            var c = a.response,
              d = this.keyCodes,
              e = this.chart,
        ...
        c.prototype.onInputKbdMove = function (a) {
          ...
          1 < d || 0 > d ? b.accessibility && (b.accessibility.keyboardNavigation.tabindexContainer.focus(), b.accessibility.keyboardNavigation.move(a)) : c && (a = c[d ? "maxDateBox" : "minDateBox"], c = c[d ? "maxInput" : "minInput"],
        ...
        c.prototype.initDropdownNav = function () {
          var a = this,
            ...
            c = b.rangeSelector,
            e = c && c.dropdown;
          c && e && (b.setFocusToElement(c.buttonGroup, e), this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(),
            this.removeDropdownKeydownHandler = n(e, "keydown", function (c) {
      ...
      (function (c) {
        function e(a) {
          ...
          return b[a] ? (this.setFocusToElement(b[a].box, b[a].element), a !== d && (this.oldRangeSelectorItemState =
        ...
        c.compose = function (c, g) {
          -1 === b.indexOf(c) && (b.push(c), c.prototype.highlightRangeSelectorButton = e); - 1 === b.indexOf(g) && (b.push(g), n(a, "afterBtnClick", d))
        }
      })(h || (h = {}));
      return h
    });
  t(a, "Accessibility/Components/SeriesComponent/ForcedMarkers.js", [a["Core/Utilities.js"]], function (a) {
    ...
    (function (a) {
      ...
      function g(a) {
        this.resetA11yMarkerOptions = k(a.options.marker || {}, this.userOptions.marker || {})
      }
      ...
      function n() {
        ...
        if (e) {
          if (a.marker && !1 ===
            a.marker.enabled && (this.a11yMarkersForced = !0, m(this.options)), this._hasPointMarkers && this.points && this.points.length)
            for (a = this.points.length; a--;) {
              e = this.points[a];
              var d = e.options,
                b = e.hasForcedA11yMarker;
              delete e.hasForcedA11yMarker;
              d.marker && (b = b && 0 === q(d), d.marker.enabled && !b ? (k(!0, d.marker, {
                states: {
                  normal: {
                    opacity: q(d) || 1
                  }
                }
              }), e.hasForcedA11yMarker = !1) : !1 === d.marker.enabled && (m(d), e.hasForcedA11yMarker = !0))
            }
      ...
      var x = [];
      a.compose = function (a) {
        -1 === x.indexOf(a) && (x.push(a), h(a, "afterSetOptions", g), h(a, "render", n), h(a, "afterRender", r))
      }
    })(q || (q = {}));
    return q
  });
  t(a, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js", [a["Core/Series/Point.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Globals.js"], a["Core/Utilities.js"],
    a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/ChartUtilities.js"]
  ], function (a, h, r, q, m, w, t, v) {
    function g(a) {
      var b = a.index,
        c = a.series.points,
        d = c.length;
    ...
    r = function () {
      ...
      b.prototype.onDrillupAll = function () {
        var a = this.lastDrilledDownPoint,
          b = this.chart,
          d = a && G(b, a.seriesName),
          e;
        a && d && u(a.x) && u(a.y) && (e = C(d, a.x, a.y));
        e = e || c(b);
      ...
      b.prototype.getKeyboardNavigationHandler = function () {
        ...
        return new w(f, {
          keyCodeMap: [
            ...
            [g ? [b.left,
              b.right
            ] : [b.up, b.down], function (b) {
              return a.onKbdVertical(this, b)
            }],
            [
              [b.enter, b.space],
              function (a, b) {
                if (a = f.highlightedPoint) b.point = a, y(a.series, "click", b), a.firePointEvent("click");
                return this.response.success
              }
            ],
            [
      ...
      b.prototype.onKbdVertical = function (a, b) {
        ...
        c[c.highlightedPoint && c.highlightedPoint.series.keyboardMoveVertical ? "highlightAdjacentPointVertical" :
    ...
    (function (a) {
      function c(a) {
        var b = this.series,
          ...
          d = c && g(c) || 0,
          e = c && c.series.points || [],
          f = this.series && this.series[this.series.length -
            1];
        ...
        return x(d) ? (b = d.series, k(b) ? this.highlightedPoint = a ? b.points[b.points.length - 1] : b.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(a)) : d.highlight()
      }
      ...
      function e(a) {
        ...
        if (!this.highlightedPoint) return c = a ? this.series && this.series[0] : c, (d = a ? c && c.points && c.points[0] : d) ? d.highlight() :
          !1;
      ...
      function n() {
        ...
        if (a && c) {
          for (var d = b; d < c; ++d)
            if (!x(a[d])) return a[d].highlight();
          for (; 0 <= b; --b)
            if (!x(a[b])) return a[b].highlight()
        }
        return !1
      }
      var m = [];
      a.compose = function (a, f, g) {
        -1 === m.indexOf(a) && (m.push(a), a = a.prototype, a.highlightAdjacentPoint = c, a.highlightAdjacentPointVertical = d, a.highlightAdjacentSeries = e); - 1 === m.indexOf(f) && (m.push(f), f.prototype.highlight = h); - 1 === m.indexOf(g) && (m.push(g), f = g.prototype, f.keyboardMoveVertical = !0, ["column", "gantt", "pie"].forEach(function (a) {
          b[a] && (b[a].prototype.keyboardMoveVertical = !1)
        }), f.highlightNextValidPoint = n)
      }
    })(r || (r = {}));
    return r
  });
  t(a, "Accessibility/Components/SeriesComponent/SeriesComponent.js",
    [a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Components/SeriesComponent/ForcedMarkers.js"], a["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"], a["Accessibility/Components/SeriesComponent/SeriesDescriber.js"], a["Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js"], a["Core/Tooltip.js"]],
    function (a, h, r, q, m, w, t) {
      var k = this && this.__extends || function () {
          var a = function (c, e) {
            a = Object.setPrototypeOf || {
              __proto__: []
      ...
      return function (a) {
        ...
        c.prototype.hideTooltipFromATWhenShown = function () {
          var a = this;
          this.addEvent(t, "refresh", function () {
  ...
  t(a, "Accessibility/Components/ZoomComponent.js", [a["Accessibility/AccessibilityComponent.js"],
    ...
    a = function (a) {
      ...
      h.prototype.onChartUpdate = function () {
        var a = this.chart,
          e = this;
        a.mapNavigation && a.mapNavigation.navButtons.forEach(function (c,
          b) {
          t(a, c.element);
      ...
      h.prototype.createZoomProxyButton = function (a, e, d) {
        this[e] = this.proxyProvider.addProxyElement("zoom", {
          click: a
        }, {
          "aria-label": d,
          tabindex: -1
        ...
        return new q(e, {
          keyCodeMap: [
            [
              ...
              function (a) {
                return d.onMapKbdArrow(this, a)
              }
            ],
            [
              [a.tab],
              function (a, c) {
                return d.onMapKbdTab(this, c)
              }
            ],
            [
              [a.space, a.enter],
          ...
          validate: function () {
            return !!(e.mapZoom && e.mapNavigation && e.mapNavigation.navButtons.length)
          },
          init: function (a) {
            return d.onMapNavInit(a)
          }
        })
      };
      ...
      h.prototype.onMapKbdTab = function (a, e) {
        var c = this.chart;
        a = a.response;
        var b = (e = e.shiftKey) && !this.focusedMapNavButtonIx || !e && this.focusedMapNavButtonIx;
      ...
      h.prototype.onMapNavInit = function (a) {
        var c = this.chart,
          d = c.mapNavigation.navButtons[0],
          b = c.mapNavigation.navButtons[1];
        d = 0 < a ? d : b;
        ...
        return new q(h, {
          keyCodeMap: [
            [
              ...
              function (a, c) {
                return this.response[a === b.tab && c.shiftKey || a === b.left || a === b.up ? "prev" : "next"]
              }
            ],
            [
              [b.space,
          ...
          validate: function () {
            return h[a] && h[a].box && c[e].buttonElement
          },
          init: function () {
            h.setFocusToElement(h[a].box, c[e].buttonElement)
          }
        })
      };
      h.prototype.getKeyboardNavigation = function () {
        return [this.simpleButtonNavigation("resetZoomButton", "resetZoomProxyButton", function (a, e) {
          e.zoomOut()
        }), this.simpleButtonNavigation("drillUpButton", "drillUpProxyButton", function (a, e) {
          e.drillUp();
    ...
    (function (a) {
      ...
      a.composedClasses = [];
      a.compose = function (c) {
        -1 === a.composedClasses.indexOf(c) && (a.composedClasses.push(c), c.prototype.panStep = g)
      }
    })(a || (a = {}));
    return a
  });
  t(a, "Accessibility/HighContrastMode.js", [a["Core/Globals.js"]], function (a) {
    ...
    return {
      isHighContrastModeActive: function () {
        var a =
          /(Edg)/.test(q.navigator.userAgent);
        if (q.matchMedia && a) return q.matchMedia("(-ms-high-contrast: active)").matches;
        if (k && q.getComputedStyle) {
          ...
          var r = (a.currentStyle || q.getComputedStyle(a)).backgroundImage;
    ...
    function (a) {
      ...
      function k(a, k, m, c) {
        ...
        Object.keys(c).forEach(function (e) {
          var f, g = d[e];
          "undefined" !== typeof g && (h(b, c[e], g), t(32, !1, a, (f = {}, f[k.join(".") + "." + e] = m.join(".") + "." + c[e].join("."), f)))
        })
      }
      ...
      function m(a) {
        a.axes.forEach(function (g) {
          (g = g.options) && g.description && (g.accessibility = g.accessibility || {}, g.accessibility.description = g.description, t(32, !1, a, {
      ...
      function w(a) {
        ...
        a.series.forEach(function (k) {
          Object.keys(g).forEach(function (c) {
            ...
            "undefined" !== typeof d && (h(k.options, g[c], "skipKeyboardNavigation" === c ? !d : d), t(32, !1, a, (e = {}, e["series." + c] = "series." + g[c].join("."), e)))
          })
        })
      }
      var t = a.error,
      ...
      return function (a) {
        ...
        k(a, ["accessibility", "keyboardNavigation"], ["accessibility", "keyboardNavigation", "seriesNavigation"], {
          skipNullPoints: ["skipNullPoints"],
          mode: ["mode"]
        });
        k(a, ["lang", "accessibility"],
          ["lang", "accessibility"], {
  ...
  t(a, "Accessibility/Accessibility.js", [a["Core/DefaultOptions.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/A11yI18n.js"], a["Accessibility/Components/ContainerComponent.js"], a["Accessibility/FocusBorder.js"], a["Accessibility/Components/InfoRegionsComponent.js"], a["Accessibility/KeyboardNavigation.js"], a["Accessibility/Components/LegendComponent.js"], a["Accessibility/Components/MenuComponent.js"], a["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"],
  ...
  ], function (a, h, r, q, m, w, t, v, g, n, x, c, e, d, b, f, u, y, M, G) {
    a = a.defaultOptions;
    var k = h.doc,
      B = r.addEvent,
      C = r.extend,
    ...
    h = function () {
      ...
      a.prototype.init = function (a) {
        this.chart = a;
        k.addEventListener && a.renderer.isSVG ? (G(a), this.proxyProvider = new c(this.chart), this.initComponents(), this.keyboardNavigation = new v(a, this.components)) : (this.zombie = !0, this.components = {}, a.renderTo.setAttribute("aria-hidden", !0))
      };
      a.prototype.initComponents = function () {
        ...
        f.customComponents && C(this.components, f.customComponents);
    ...
    (function (a) {
      ...
      a.compose =
        function (a, l, p, t, u, y, z) {
          ...
          q.compose(l);
          w.compose(l, y);
          z && e.compose(l, z); - 1 === r.indexOf(l) && (r.push(l), l.prototype.updateA11yEnabled = k, B(l, "destroy", c), B(l, "render", f), B(l, "update", h), ["addSeries", "init"].forEach(function (a) {
            B(l, a, function () {
              this.a11yDirty = !0
            })
            ...
            B(t, "update", m)); - 1 === r.indexOf(u) && (r.push(u), ["update", "updatedData", "remove"].forEach(function (a) {
            B(u, a, function () {
  ...
  ], function (a, h, r, q, m, t, C) {
    a.i18nFormat = h.i18nFormat;
    a.A11yChartUtilities = q;
    a.A11yHTMLUtilities = m;
    a.AccessibilityComponent = r;
    a.KeyboardNavigationHandler = t;
    a.SeriesAccessibilityDescriber = C;
