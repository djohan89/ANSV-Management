  ...
  M(f, "Core/Renderer/HTML/AST.js", [f["Core/Globals.js"], f["Core/Utilities.js"]], function (a, f) {
    ...
    B = function () {
      ...
      h.filterUserAttributes = function (d) {
        p(d, function (e, l) {
          var n = !0; - 1 === h.allowedAttributes.indexOf(l) && (n = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(l) && (n = z(e) && h.allowedReferences.some(function (d) {
          ...
          ["width", "height"].forEach(function (b) {
            J[b + "Setter"] = function (b, g) {
              ...
              c(d) && (E && "within" === E.backgroundSize && this.width && this.height && (d = Math.round(d * Math.min(this.width / this.imgwidth, this.height / this.imgheight))), this.element && this.element.setAttribute(g, d),
                this.alignByTranslate || (b = ((this[g] || 0) - d) / 2, this.attr("width" === g ? {
                  translateX: b
                } : {
                  translateY: b
                })))
          ...
          if (!l) {
            ...
            for (q = d.length; !r && q--;) {
              ...
              if (p = g[p].label) p.styles && "ellipsis" === p.styles.textOverflow ? p.css({
                  ...
                  width: h + "px"
                }), p.getBBox().height > this.len / d.length -
        ...
        function () {
          ...
          if (!c.axisGroup) {
            var Q = function (c, a, d) {
              return x.g(c).attr({
                zIndex: d
              }).addClass("highcharts-" + h.toLowerCase() + a + " " + (b.isRadial ? "highcharts-radial-axis" +
                a + " " : "") + (w || "")).add(f)
            };
  ...
  M(f, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [f["Core/Utilities.js"]], function (a) {
    ...
    (function (a) {
      ...
      a.compose = function (a, f) {
        B || (B = a); - 1 === u.indexOf(f) && (u.push(f), C(f.prototype, z.prototype));
        return f
      };
      var z = function () {
        function a() {}
    ...
    a = function () {
      ...
      a.prototype.onContainerClick = function (a) {
        ...
        d.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (l(c.series, "click", e(a, {
          point: c
        })), d.hoverPoint && c.firePointEvent("click", a)) : (e(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX -
          g, a.chartY - b, {
            visiblePlotOnly: !0
          }) && l(d, "click", a)))
      };
      ...
      a.prototype.runPointActions = function (e, f) {
        ...
        if (k && (k !== c.hoverPoint || g && g.isHidden)) {
          ...
          g && !g.isHidden && (b = g.getAnchor([{}], e), c.isInsidePlot(b[0], b[1], {
            visiblePlotOnly: !0
          }) && g.updatePosition({
            plotX: b[0],
            plotY: b[1]
    ...
    H = function () {
      ...
      a.prototype.renderItem = function (b) {
        ...
        E || (b.legendGroup = c.g("legend-item").addClass("highcharts-" + n.type + "-series highcharts-color-" + b.colorIndex + (w ? " " + w : "") + (m ? " highcharts-series-" + b.index : "")).attr({
          zIndex: 1
        }).add(this.scrollGroup), b.legendItem = E = c.text("",
    ...
    a = function () {
      ...
      a.prototype.update = function (b, a, c, e) {
        ...
        if (n) {
          ...
          X(n, function (b, a) {
            -1 !== g.propsRequireUpdateSeries.indexOf("chart." + a) && (l = !0); - 1 !== g.propsRequireDirtyBox.indexOf(a) && (g.isDirtyBox = !0); - 1 !== g.propsRequireReflow.indexOf(a) && (k ? g.isDirtyBox = !0 : m = !0)
          });
    ...
    a = function () {
      ...
      a.prototype.setData = function (a, b, c, d) {
        ...
        if (!w) {
          ...
          if (m && x > m)
            ...
            for (c = 0; c < x; c++) "undefined" !== typeof a[c] && (d = {
              series: e
      ...
      a.prototype.animate = function (a) {
        ...
        if (a && c) g = this.getClipBox(), k ? k.attr("height", g.height) : (g.width = 0, e && (g.x = b.plotHeight), k = b.renderer.clipRect(g),
          ...
          }), b.sharedClips[f + "m"] = h), c.clip(k), d && d.clip(h);
      ...
      a.prototype.setState = function (a, b) {
        ...
        if (c.state !== a && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (b) {
          ...
          if (e && !e.dashstyle)
            for (d = {
                "stroke-width": h
              }, e.animate(d, k); c["zone-graph-" + l];) c["zone-graph-" + l].animate(d, k), l += 1;
        ...
        function l() {
          ...
          if (z(q) || q.enabled || a._hasPointLabels) {
            ...
            !l && (l = a.dataLabelsGroup) &&
              (a.visible && A.show(!0), l[f.animation ? "animate" : "attr"]({
                opacity: 1
              }, t));
            b.forEach(function (b) {
  ...
  M(f, "Series/Column/ColumnDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Series/SeriesRegistry.js"],
    ...
    (function (f) {
      ...
      f.compose = function (f) {
        a.compose(F); - 1 === p.indexOf(f) && (p.push(f), f.prototype.alignDataLabel = z)
      }
    })(I || (I = {}));
    return I
  });
  ...
  M(f, "Series/Pie/PieDataLabel.js", [f["Core/Series/DataLabel.js"], f["Core/Globals.js"], f["Core/Renderer/RendererUtilities.js"], f["Core/Series/SeriesRegistry.js"], f["Core/Utilities.js"]], function (a, f, C, G, u) {
    ...
    (function (f) {
      ...
      f.compose = function (d) {
        a.compose(B); - 1 === y.indexOf(d) && (y.push(d), d = d.prototype, d.dataLabelPositioners = A, d.alignDataLabel = F, d.drawDataLabels = h, d.placeDataLabels = t, d.verifyDataLabelOverflow = u)
      }
    })(h || (h = {}));
    return h
  });
